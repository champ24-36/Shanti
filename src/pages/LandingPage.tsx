...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sage-50 via-white to-lavender-50 dark:from-sage-900 dark:via-gray-900 dark:to-lavender-900 transition-colors duration-300">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={toggleTheme}
                className="text-sage-700 dark:text-sage-300 hover:text-purple-700 dark:hover:text-purple-300 font-medium transition-colors"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            >
              <Link
                to="/auth"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-800 to-lavender-600 text-white font-semibold rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-200"
              >
                Begin Your Journey
              ...
              <button 
                ...
                className="inline-flex items-center px-8 py-4 border-2 border-sage-200 dark:border-sage-700 text-sage-700 dark:text-sage-300 font-semibold rounded-xl hover:bg-sage-50 dark:hover:bg-sage-900 transition-all duration-200"
              >
                Learn More
              </button>
            </motion.div>
      ...
      {/* Features Section */}
      <section id="features-section" className="py-20 bg-white/50 dark:bg-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-blue-900 to-lavender-600 dark:from-black-700 dark:to-lavender-700">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-4xl font-bold text-purple-200 mb-6">
            ...
            <Link
              to="/auth"
              className="inline-flex items-center px-8 py-4 border-2 border-sage-200 dark:border-sage-200 text-sage-100 dark:text-sage-100 font-semibold rounded-xl hover:bg-sage-50 dark:hover:bg-sage-900 transition-all duration-200"
            >
