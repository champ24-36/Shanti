    ...
    <div className="h-full flex flex-col">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-6 mb-6 text-white">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">AI Mental Health Support</h1>
      ...
      <div className="flex-1 chat-container card p-6 overflow-y-auto">
      ...
      <form onSubmit={handleSendMessage} className="mt-4">
        <div className="flex space-x-4">
          ...
          <button
            ...
            className="px-6 py-4 btn-gradient rounded-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
          >
      ...
      {/* Helpful Tips */}
      <div className="mt-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-700 rounded-xl p-4">
        <div className="flex items-start space-x-3">
